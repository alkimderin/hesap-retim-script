...
CREATE TABLE IF NOT EXISTS `settings` (
  ...
  `footer` varchar(1000) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL DEFAULT '&copy; 24/7 | <a href=https://www.indirbi.com>indirbi</a>',
...
('NurullahTR', 'paypal@money.com', 'Â© NurullahTR , indirbi.com', ''),
('NurullahTR', 'paypal@money.com', 'Â© NurullahTR , indirbi.com', '');
